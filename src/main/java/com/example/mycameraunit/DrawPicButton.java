...
public class DrawPicButton extends AppCompatButton {
    ...
    public DrawPicButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }
    public DrawPicButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public DrawPicButton(Context context) {
        this(context, null);
    }
